...
/**
 * Describes chrome driver browser metadata.
 *
 * @author Kimi Liu
 * @since Java 17+
 */
public final class ChromeDriverBrowserData {

    /**
     * Creates a chrome driver browser data.
     */
    private ChromeDriverBrowserData() {
    ...
    public static String resolveDownloadUrl(BrowserPlatform platform, String buildId, String baseUrl) {
        return ChromeBrowserData.resolveArtifactDownloadUrl(platform, buildId, baseUrl, "chromedriver");
    }
    ...
    public static List<String> resolveDownloadPath(BrowserPlatform platform, String buildId) {
        return ChromeBrowserData.resolveArtifactDownloadPath(platform, buildId, "chromedriver");
    }
    ...
    public static Path relativeExecutablePath(BrowserPlatform platform, String buildId) {
        ...
        return switch (Assert.notNull(platform, "platform")) {
            case MAC, MAC_ARM64, LINUX, LINUX_ARM64 -> Path.of("chromedriver-" + folder, "chromedriver");
            case WIN32, WIN64 -> Path.of("chromedriver-" + folder, "chromedriver.exe");
        };
    }
